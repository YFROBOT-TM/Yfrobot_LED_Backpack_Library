/*!
 * @file Yfrobot_LEDBackpack.h
 * Yfrobot LED Backpack library for Arduino.
 * 
 * @Revised by YFROBOT
 * 
...
#ifndef Yfrobot_LEDBackpack_h
#define Yfrobot_LEDBackpack_h
...
*/
class Yfrobot_LEDBackpack {
public:
  /*!
    @brief  Constructor for HT16K33 devices.
  */
  Yfrobot_LEDBackpack(void);
...
*/
class Adafruit_24bargraph : public Yfrobot_LEDBackpack {
public:
  /*!
...
/******************10 BARGRAPH displays of YFROBOT**************************/
/*!
    @brief  Class for 10-element bargraph displays.
*/
class Yfrobot_10bargraph : public Yfrobot_LEDBackpack {
public:
  /*!
    @brief  Constructor for 10-element bargraph displays.
  */
  Yfrobot_10bargraph(void);

  /*!
    @brief  Set color a single bar (dot).
    @param  bar    Bar index (0 to 9).
  */
...
*/
class Adafruit_8x16matrix : public Yfrobot_LEDBackpack, public Adafruit_GFX {
public:
  /*!
...
*/
class Adafruit_8x16minimatrix : public Yfrobot_LEDBackpack,
                                public Adafruit_GFX {
public:
  /*!
...
*/
class Adafruit_8x8matrix : public Yfrobot_LEDBackpack, public Adafruit_GFX {
public:
  /*!
...
public:
  ...
  void scrollMessage(const String &s, int displayScrollSpeed = 300);
  void scrollMessage(int num, int displayScrollSpeed = 300);
  void scrollMessage(float num, int displayScrollSpeed = 300);
};
...
*/
class Adafruit_AlphaNum4 : public Yfrobot_LEDBackpack {
public:
  /*!
...
/*********************************3-bit 7-segment numeric displays of YFROBOT**************************************/
#define RAW_BITS 0 ///< Issue 7-segment data as raw bits

/*!
    @brief  Class for  3-bit 7-segment numeric displays of YFROBOT.
*/
class Yfrobot_3bit_7segment : public Yfrobot_LEDBackpack {
public:
  /*!
    @brief  Constructor for 7-segment numeric displays.
  */
  Yfrobot_3bit_7segment(void);
